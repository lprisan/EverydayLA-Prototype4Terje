...
```{r}
#TODO: Filter out empty/semi-empty open questions and lessons!
...
selectInput("question", label = "Please select the discussed question:",
            choices = question, selected = question[1])
```
...
```{r}
# TODO: Change this to show actual feedback!
library(Hmisc)
